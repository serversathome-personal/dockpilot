...
export default function Header() {
  const { wsConnected, notifications, removeNotification, clearNotifications } = useStore();
  ...
  return (
    <header className="h-16 bg-glass-dark backdrop-blur-xl border-b border-glass-border flex-shrink-0 relative z-50">
      <div className="h-full px-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative" ref={notificationRef}>
            ...
            {showNotifications && (
              <div className="absolute right-0 mt-2 w-96 bg-glass-dark/95 backdrop-blur-xl border border-glass-border rounded-lg shadow-glass-lg z-[100] max-h-[500px] overflow-hidden flex flex-col">
